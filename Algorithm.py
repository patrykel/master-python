...
# here I want to create dataframe for results
N_row_limit = 500
...
for event_id, group_id in iterable_event_group_list:
    ...
    row_df = get_solution_df(event_id, group_id, method, exec_time, solution, hit_lines, geom_df, with_det_distances=True)
